...
queries = [
	...
	"america enters the war against germany",
	"what happened to germany after the world war"
]

obj.build_index()

for query in queries:
	obj.exact_query(query, 5)
	obj.inexact_query_champion(query, 5)
	obj.inexact_query_index_elimination(query, 5)
	obj.inexact_query_cluster_pruning(query, 5)